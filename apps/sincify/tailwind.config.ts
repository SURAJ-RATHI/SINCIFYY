  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "sincify-textfield": "var(--SincifyTextField--background)",
        "sincify-textfield-readonly":
          "var(--SincifyTextField--readonly--background)",
      ...
      textColor: {
        "sincify-textfield": "var(--SincifyTextField--color)",
        "sincify-textfield-label": "var(--SincifyTextField--label-color)",
        "sincify-textfield-readonly":
          "var(--SincifyTextField--readonly--color)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      borderColor: {
        "sincify-textfield": "var(--SincifyTextField--border)",
        "sincify-textfield-readonly":
          "var(--SincifyTextField--readonly--border)",
        "sincify-textfield-hover": "var(--SincifyTextField--border-hover)",
        "sincify-textfield-active": "var(--SincifyTextField--border-active)",
        "sincify-textfield-placeholder": "var(--SincifyTextField--placeholder)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      fontFamily: {
        ...
        sincifyfont: ["Sincifyfont", "sans-serif"],
      },
      filter: {
