...
export function MainMenuWelcome() {
    return (
        <div className="sincifyfont welcome-screen-decor welcome-screen-decor-hint welcome-screen-decor-hint--menu">
            ...
            <div className="welcome-screen-decor-hint__label font-sincifyfont">Export, preferences, languages, ...</div>
        </div>
    )
}
...
export function ToolMenuWelcome() {
    return (
        <div className="sincifyfont z-[4] welcome-screen-decor welcome-screen-decor-hint welcome-screen-decor-hint--toolbar">
    ...
    return (
        <>
            <div className="welcome-screen-center z-[3]">
                <div className="welcome-screen-center__logo sincifyfont welcome-screen-decor">
                    <div className="SincifyLogo is-small">
                        {/* <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="SincifyLogo-icon">
                        ...
                        <h1 className="brand-title SincifyLogo-text font-sincifyfont">Sincify</h1>
                    </div>
                </div>
                <div className="welcome-screen-center__heading welcome-screen-decor font-sincifyfont">All your data is saved locally in your browser.</div>
