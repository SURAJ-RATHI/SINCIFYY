                ...
                {isLoading ? (
                    ...
                    rooms.map((room) => (
                        <div key={room.id} className="flex justify-between items-center transition-colors">
                            <span className="flex-1 bg-sincify-textfield border border-sincify-textfield rounded-md px-3 py-2 text-text-primary-color overflow-hidden text-ellipsis mr-3 select-none">{room.id}</span>
